   (function(window) {
       ...
       for (let i = 4; i < 24; i++) {
           for (let j = 0; j < 11; j++) {
               div_GP.innerHTML += "<div class='cell'  id='CS_" + i + "_" + j + "'  value=0 ></div>";
           }
       }
       ...
       for (let k = 0; k < 4; k++) {
           for (let z = 0; z < 4; z++) {
               div_NSP.innerHTML += "<div class='cell' id='NS_" + k + "_" + z + "' value=0 ></div>";
           }
       }
       ...
       function refreshShape(i) {
           for (let i = 0; i < 4; i++) {
               ...
               if (current_x > 3) {
                   refreshCells("CS_" + current_x + "_" + current_y, i);
               }
           }
       }
